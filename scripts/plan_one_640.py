...
class ESM_Model(nn.Module):
    ...
    def forward(self, inputs):
        ...
        outputs_esm_last_2d=pad_tensor_to_shape(outputs_esm_last,(16, 400, 640))
...
class Prot_Model(nn.Module):
    ...
    def forward(self, inputs2):
        ...
        outputs_pro_2d = F.interpolate(outputs_pro_last, size=(400, 640), mode='bilinear', align_corners=False)
...
class MyModel(nn.Module):
    def __init__(self,):
        ...
        self.bilstm1 = nn.LSTM(640, 256, num_layers=1, bidirectional=True) 
        self.conv4=nn.Conv2d(1,3,kernel_size=(4,640))
        self.conv5=nn.Conv2d(1,3,kernel_size=(5,640))
        self.conv6=nn.Conv2d(1,3,kernel_size=(6,640))
...
optimizer = torch.optim.Adam(model.parameters(), lr=0.000066)
