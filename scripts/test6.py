...
class ESM_Model(nn.Module):
    ...
    def forward(self, inputs):
        ...
        outputs_esm_2d = F.interpolate(outputs_esm_last_2d, size=(400, 1024), mode='bilinear', align_corners=False)

        
        return outputs_esm_2d,outputs_esm_pool
...
class MyModel(nn.Module):
    def __init__(self,):
        ...
        self.fc_class1 = nn.Linear(1024*2, 2)
        self.bilstm1 = nn.LSTM(1024, 512, num_layers=1, bidirectional=True) 
    ...
    def forward(self, inputs,inputs2):
        ...
        lstm_pool_esm=self.fc2(lstm_pool_esm)
