...
for fold, (train_indices, valid_indices) in enumerate(kf.split(train_dataset)):
    ...
    for epoch in range(10):
        ...
        if auc>best_auc:
            ...
            best_tpr=tpr
            best_auc=auc
            file_path = "outputs/our/5_fold_roc_our_{}.pth".format(fold)
            if not os.path.exists("outputs/our"):
                os.makedirs("outputs/our")
            torch.save(model.state_dict(), file_path)
...
plt.savefig('outputs/our/5_fold_roc_our.png',dpi=400)
