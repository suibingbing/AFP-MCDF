...
class Prot_Model(nn.Module):
    ...
    def forward(self, inputs2):
        ...
        outputs_pro_2d = outputs_pro_last.unsqueeze(1)
        outputs_pro_2d = F.interpolate(outputs_pro_2d, size=(400, 480), mode='bilinear', align_corners=False)
...
class Fusion(nn.Module):
    def __init__(self,):
        ...
        self.fc=nn.Linear(3564, 1024)
        self.fc2=nn.Linear(1024, 480)
        self.dropout = nn.Dropout(0.2)  

    def forward(self, output_2d_esm,lstm_pool_esm,output_2d_pro,lstm_pool_pro):
...
class MyModel(nn.Module):
    ...
    def forward(self, inputs,inputs2):
        ...
        x=self.fusion(output_2d_esm,lstm_pool_esm,output_2d_pro,lstm_pool_pro)
...
#     {'params': model.esm_based.parameters(), 'lr': 0.000066},
...
plt.savefig('outputs/lr/5_fold_roc_0.0000660.png',dpi=400)
